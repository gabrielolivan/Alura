...
class TestLeilao(TestCase):
    ...
    def test_deve_retornar_o_maior_e_o_menor_valor_de_um_lance_quando_adicionador_em_ordem_crescente(self):
    ...
    # se o ultimo usuario for direferente, deve permmitir propor o lance

    def test_deve_permitir_porpor_um_lance_caso_o_ultimo_usuario_seja_diferente(self):
        yuri = Usuario('Yuti', 500.0)
