...
def test_deve_permitir_prpor_lance_quando_o_valor_eh_menor_que_o_valor_da_carteira(vini, leilao):
...
def test_deve_permitir_prpor_lance_quando_o_valor_eh_igual_ao_valor_da_carteira(vini, leilao):
